...
assert.ok(Array.isArray(provenanceSchema.anyOf));
const rawVariant = provenanceSchema.anyOf.find((variant) => variant.properties.source_type.enum[0] === 'RAW_TEXT');
